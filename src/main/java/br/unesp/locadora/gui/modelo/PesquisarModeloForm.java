...
public class PesquisarModeloForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Modelo> resultado;
    ...
    /**
     * Creates new form PesquisarModeloForm
     */
    public PesquisarModeloForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "Marca", "Ano", "Categoria", "Características" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = modeloService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Modelo> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarModeloForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarModeloForm().setVisible(true);
            }
        });
    }
