...
public class PesquisarCaracteristicaForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Caracteristica> resultado;
    ...
    /**
     * Creates new form PesquisarCaracteristicaForm
     */
    public PesquisarCaracteristicaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisar Característica");
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = caracteristicaService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Caracteristica> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarCaracteristicaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarCaracteristicaForm().setVisible(true);
            }
        });
    }
