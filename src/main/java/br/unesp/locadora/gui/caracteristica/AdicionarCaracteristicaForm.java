...
public class AdicionarCaracteristicaForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdicionarCaracteristicaForm
     */
    public AdicionarCaracteristicaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Adicionar Característica");
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        try {
            ...
            if (fechar) {
                ...
                JOptionPane.showMessageDialog(this, "Característica adicionada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarCaracteristicaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdicionarCaracteristicaForm().setVisible(true);
            }
        });
    }
