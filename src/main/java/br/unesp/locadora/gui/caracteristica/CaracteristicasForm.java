...
public class CaracteristicasForm extends javax.swing.JFrame {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        PesquisarCaracteristicaForm form = new PesquisarCaracteristicaForm();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (idLinhaSelecionada() != -1) {
            ...
            EditarCaracteristicaForm form = new EditarCaracteristicaForm();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (idLinhaSelecionada() != -1) {
            if (JOptionPane.showConfirmDialog(this, "Deseja realmente excluir a característica selecionada?", "Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                try {
                    caracteristicaService.delete(caracteristicaService.getById(idLinhaSelecionada()));
     ...
     * @param dados Dados.
     */
    private void atualizarTabela(List<Caracteristica> dados) {
        JTableUtil.fillCaracteristicas(tabela, dados);
        removerSelecao();
    }
    ...
    private void atualizarTabela() {
        atualizarTabela(caracteristicaService.list());
    }
