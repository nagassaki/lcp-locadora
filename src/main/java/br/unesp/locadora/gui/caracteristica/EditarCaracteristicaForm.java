...
public class EditarCaracteristicaForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditarCaracteristicaForm
     */
    public EditarCaracteristicaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Editar Característica");
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_caracteristica.png"))); // NOI18N
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        try {
            ...
            Caracteristica caracteristica = caracteristicaService.getById(id);
            caracteristica.setNome(txtNome.getText().trim());

            caracteristicaService.save(caracteristica);

            JOptionPane.showMessageDialog(this, "Característica atualizada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void preencherFormulario() {
        Caracteristica caracteristica = caracteristicaService.getById(id);
        txtNome.setText(caracteristica.getNome());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCaracteristicaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarCaracteristicaForm().setVisible(true);
            }
        });
    }
