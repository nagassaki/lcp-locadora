...
public class PesquisarFisicaForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Fisica> resultado;
    ...
    /**
     * Creates new form PesquisarFisicaForm
     */
    public PesquisarFisicaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "CPF", "RG", "Nascimento", "Telefone", "E-mail" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = fisicaService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Fisica> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarFisicaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarFisicaForm().setVisible(true);
            }
        });
    }
