...
public class CategoriasForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_categorias.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(painel1, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        PesquisarCategoriaForm form = new PesquisarCategoriaForm();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (idLinhaSelecionada() != -1) {
            ...
            EditarCategoriaForm form = new EditarCategoriaForm();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (idLinhaSelecionada() != -1) {
            if (JOptionPane.showConfirmDialog(this, "Deseja realmente excluir a categoria selecionada?", "Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                try {
                    categoriaService.delete(categoriaService.getById(idLinhaSelecionada()));
     ...
     * @param dados Dados.
     */
    private void atualizarTabela(List<Categoria> dados) {
        JTableUtil.fillCategorias(tabela, dados);
        removerSelecao();
    }
    ...
    private void atualizarTabela() {
        atualizarTabela(categoriaService.list());
    }
