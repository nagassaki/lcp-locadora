...
public class PesquisarCategoriaForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Categoria> resultado;
    ...
    /**
     * Creates new form PesquisarCategoriaForm
     */
    public PesquisarCategoriaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_pesquisar.png"))); // NOI18N
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "Diária", "Multa" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = categoriaService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Categoria> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarCategoriaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarCategoriaForm().setVisible(true);
            }
        });
    }
