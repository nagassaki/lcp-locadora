...
public class PesquisarAtivosForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PesquisarPedidosAtivosForm
     */
    public PesquisarAtivosForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Data", "Veículo", "Cliente", "Valor", "Retirada", "Devolução" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = pedidoService.listAtivos(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarAtivosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarAtivosForm().setVisible(true);
            }
        });
    }
