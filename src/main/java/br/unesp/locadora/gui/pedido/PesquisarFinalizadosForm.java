...
public class PesquisarFinalizadosForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PesquisarFinalizadosForm
     */
    public PesquisarFinalizadosForm() {
        initComponents();
    }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = pedidoService.listFinalizados(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarFinalizadosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarFinalizadosForm().setVisible(true);
            }
        });
    }
