...
public class CoresForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_cores.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(painel1, javax.swing.GroupLayout.DEFAULT_SIZE, 386, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        PesquisarCorForm form = new PesquisarCorForm();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (idLinhaSelecionada() != -1) {
            ...
            EditarCorForm form = new EditarCorForm();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (idLinhaSelecionada() != -1) {
            if (JOptionPane.showConfirmDialog(this, "Deseja realmente excluir a cor selecionada?", "Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                try {
                    corService.delete(corService.getById(idLinhaSelecionada()));
     ...
     * @param dados Dados.
     */
    private void atualizarTabela(List<Cor> dados) {
        JTableUtil.fillCores(tabela, dados);
        removerSelecao();
    }
    ...
    private void atualizarTabela() {
        atualizarTabela(corService.list());
    }

    /**
     * Retorna ID da cor selecionada.
     *
     * @return ID da cor.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CoresForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
