...
public class PesquisarCorForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Cor> resultado;
    ...
    /**
     * Creates new form PesquisarCorForm
     */
    public PesquisarCorForm() {
        initComponents();
    }
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = corService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarCorForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarCorForm().setVisible(true);
            }
        });
    }
