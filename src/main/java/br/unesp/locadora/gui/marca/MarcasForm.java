package br.unesp.locadora.gui.marca;
...
public class MarcasForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_marcas.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(painel1, javax.swing.GroupLayout.DEFAULT_SIZE, 375, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        PesquisarMarcaForm form = new PesquisarMarcaForm();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (idLinhaSelecionada() != -1) {
            ...
            EditarMarcaForm form = new EditarMarcaForm();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (idLinhaSelecionada() != -1) {
            if (JOptionPane.showConfirmDialog(this, "Deseja realmente excluir a marca selecionada?", "Aviso", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                try {
                    marcaService.delete(marcaService.getById(idLinhaSelecionada()));
     ...
     * @param dados Dados.
     */
    private void atualizarTabela(List<Marca> dados) {
        JTableUtil.fillMarcas(tabela, dados);
        removerSelecao();
    }
    ...
    private void atualizarTabela() {
        atualizarTabela(marcaService.list());
    }

    /**
     * Retorna ID da marca selecionada.
     *
     * @return ID da marca.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcasForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
