...
public class PesquisarMarcaForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Marca> resultado;
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = marcaService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Marca> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarMarcaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarMarcaForm().setVisible(true);
            }
        });
    }
