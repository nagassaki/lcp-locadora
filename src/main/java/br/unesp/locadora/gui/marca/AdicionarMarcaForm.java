...
public class AdicionarMarcaForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdicionarMarcaForm
     */
    public AdicionarMarcaForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/title_marca.png"))); // NOI18N
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        try {
            ...
            if (fechar) {
                ...
                JOptionPane.showMessageDialog(this, "Marca adicionada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdicionarMarcaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdicionarMarcaForm().setVisible(true);
            }
        });
    }
