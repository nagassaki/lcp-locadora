...
public class EditarMarcaForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditarMarcaForm
     */
    public EditarMarcaForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMarcaForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarMarcaForm().setVisible(true);
            }
        });
    }
