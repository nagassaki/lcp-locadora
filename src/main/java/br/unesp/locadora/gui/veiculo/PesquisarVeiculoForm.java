...
public class PesquisarVeiculoForm extends javax.swing.JFrame {

    /**
     * Resultado da pesquisa.
     */
    private List<Veiculo> resultado;
    ...
    /**
     * Creates new form PesquisarVeiculoForm
     */
    public PesquisarVeiculoForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbxColuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Modelo", "Cor", "Placa", "RENAVAM" }));
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        if (!txtPesquisa.getText().trim().equals("")) {
            resultado = veiculoService.list(txtPesquisa.getText().trim(), cbxColuna.getSelectedIndex());
            sair();
        }
    ...
    public List<Veiculo> getResultado() {
        return resultado;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarVeiculoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarVeiculoForm().setVisible(true);
            }
        });
    }
